# Exchange Walker Live 3.1.0 Test Results
...
- Offline source behavior: `RESULT 58 passed, 0 failed`.
- Git whitespace validation: passed.
- Mudlet package XML parsed with root `MudletPackage`.

## Exact package gates

Artifact: `dist/exchange-walker-live-3.1.0-live.mpackage`

SHA-256:

```text
FE1CEE8B42125029DE4C77386374343F351F30D8CD3B28B0DA6A5E827FD2EFDB
```

- Required members: 7/7.
- Unexpected members: 0.
- Packaged Lua syntax: passed.
- Exact-package offline behavior: `RESULT 58 passed, 0 failed`.
...
- Strict stock and spread field validation.
...
- F2CE Mux content registration, safe Stockpiles-tab placement, default-tab
  preservation, and idempotent reload.
